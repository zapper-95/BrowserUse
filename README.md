...
After installing Python, make a virtual environment, and install all the neccecssary packages using `pip install -r requirements.txt`. Then run `playwright install`.
